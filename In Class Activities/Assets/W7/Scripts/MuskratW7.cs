...
public class MuskratW7 : MonoBehaviour
{
    ...
    private void MoveOrbitMode()
    {
        ...
        _animator.SetBool("running", Math.Abs(leftright) > 0.01f || Math.Abs(forward) > 0.01f);
    ...
    private void MoveNormal()
    {
        ...
        float leftright = Input.GetAxis("Horizontal");
        transform.Rotate(Vector3.up * leftright * Time.deltaTime * _rotationSpeed);
        // STEP 1 -------------------------------------------------------------
        ...
        transform.Translate(Vector3.forward * movement * Time.deltaTime * _moveSpeed);
        ...
        _animator.SetBool("flying", Math.Abs(_rigidbody.linearVelocity.y) > 0.05);
        _animator.SetBool("running", Math.Abs(leftright) > 0.01f || Math.Abs(movement) > 0.01f);
